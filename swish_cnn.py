...
swish_x = conv2d(x_image, kernel_conv1)
h_conv1 = swish_x / (1 + tf.exp(0.021 * swish_x)) + bias_conv1 # Swish
...
for i in range(MAX_ITER):
    ...
    sfyin_step.run(feed_dict={x_holder: batch[0], y_holder: batch[1], drop_prob: 0.5})
...
plt.title('Swish function ACC performance')
